...
La experimentación se ha desarrollado por fases. Primero, se han migrado reglas económicas y estructuras de datos. Después, se han construido conjuntos supervisados para estudiar señales de mercado. Más adelante, se ha creado un conjunto de compraventa basado en precios Steam/\acroref{BUFF}{BUFF} y se ha entrenado una matriz de políticas multiagente. Esta secuencia evita entrenar agentes \acroref{MARL}{MARL} sobre un entorno que todavía no representa bien el problema económico. La Tabla~\ref{tab:matriz-experimental} resume las ejecuciones que se desarrollan con detalle en las secciones siguientes.
...
Trading BUFF--Steam & Cortes temporales iniciales y conjunto \texttt{trading\_profit\_v2} para entrenamiento multiagente. \\
OCR & Parser, umbral de confianza y recorrido de imagen. \\
\acroref{MARL}{MARL} & Controles funcionales y matriz de 21 entrenamientos con siete configuraciones y tres semillas. \\
\bottomrule
\end{tabularx}
