...
\noindent Este capítulo presenta las pruebas realizadas sobre reglas económicas, datos, modelos supervisados, OCR y arquitectura multiagente. Se separan las comprobaciones funcionales, las exploraciones iniciales de datos y la matriz de entrenamiento \acroref{MARL}{MARL}. Esta distinción evita atribuir a una verificación técnica el significado de una comparación de modelos entrenados.
...
La matriz actual entrena políticas CTDE con tres actores, Scout, Trader y Portfolio, y un modelo evaluador central utilizado solo durante el entrenamiento. Se emplea \texttt{trading\_profit\_v2}, 1.000~EUR de capital inicial, un máximo de 100 iteraciones, ocho episodios por iteración y parada temprana después de 20 iteraciones sin mejora en validación. Cada configuración se repite con las semillas 7, 19 y 31. En total se han completado 21 entrenamientos y 3.552 episodios, sin consultar el conjunto de prueba.
