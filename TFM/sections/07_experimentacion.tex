...
\caption{Evolución de las recompensas por paso durante el entrenamiento. Las bandas representan la desviación típica entre semillas.}
...
\caption{Pérdida de valor del crítico y entropía de las políticas durante el entrenamiento con PPO.}
...
\caption{Probabilidad media de cada acción al inicio y al final del entrenamiento.}
...
\bottomrule
\end{tabularx}
\caption{Retorno de validación de la cuadrícula completa MARL.}
...
\caption{Retorno de validación por tamaño y perfil de cartera.}
...
\bottomrule
\end{tabularx}
\caption{Evaluación única del valor de la cartera conjunta en prueba para la tipología media diversificada. Para MARL, el intervalo entre semillas es 6,163--6,869\,\%.}
