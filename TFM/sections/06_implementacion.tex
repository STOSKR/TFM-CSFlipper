...
La predicción tabular se implementa con scikit-learn \cite{pedregosa2011scikit}. Cada modelo entrenado se guarda con Joblib junto con un fichero que identifica sus variables de entrada, su configuración y las métricas obtenidas durante el entrenamiento. El entorno multiagente dispone de una interfaz PettingZoo \cite{terry2021pettingzoo} y de una integración con Ray/\acroref{RLlib}{RLlib} \cite{ray2018rllib}. PyTorch proporciona los componentes de cálculo empleados durante el entrenamiento \cite{paszke2019pytorch}. Las pruebas unitarias y de integración se ejecutan con \glosref{pytest}{Pytest}, una herramienta de Python para localizar y ejecutar pruebas automatizadas, y con pytest-asyncio para los casos asíncronos \cite{pytestDocs}. \glosref{ruff}{Ruff} revisa estilo y posibles errores estáticos, mientras que \glosref{mypy}{Mypy} comprueba las anotaciones de tipos antes de ejecutar el código \cite{ruffDocs,mypyDocs}. Estas herramientas materializan la propuesta, pero no sustituyen la justificación metodológica de los capítulos anteriores.
