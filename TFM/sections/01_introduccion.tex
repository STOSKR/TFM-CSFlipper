...
La comparación de precios entre plataformas plantea un problema único: decidir si un artículo merece estudiarse requiere reunir datos que llegan de fuentes distintas y aplicar sobre ellos las mismas reglas económicas. El punto de partida es un procedimiento manual en el que, para cada artículo, se anota el precio de compra, el de venta, la conversión de moneda, las comisiones, la fecha de desbloqueo y el capital bloqueado. Este procedimiento manual permite evaluar casos concretos, pero obliga a repetir el proceso de cálculos y a comprobar datos por cada artículo.
