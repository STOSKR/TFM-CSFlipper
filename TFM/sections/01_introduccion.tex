...
El problema que aborda este TFM consiste en transformar observaciones dispersas del mercado en decisiones simuladas y justificables. El sistema parte de artículos candidatos, precios obtenidos en distintas plataformas, señales de liquidez, reglas de comisión y un estado de cartera. Con esa información debe estimar si una oportunidad merece seguimiento, si conviene simular una compra o si debe descartarse por riesgo, falta de datos o beneficio insuficiente.

La dificultad principal no está en producir una predicción aislada de subida o bajada de precio. Una señal favorable puede dejar de ser útil si la posición queda bloqueada, si no hay liquidez suficiente, si las comisiones eliminan el margen o si la operación concentra demasiado capital en un mismo tipo de activo. Por ello, cada recomendación debe evaluarse por su efecto sobre el beneficio neto, el riesgo y el capital disponible.
...
En la fase corregida del proyecto, esta restricción se aborda separando entrenamiento e inferencia: Steam se usa como fuente principal para aprender patrones temporales de salida, mientras que BUFF163 se reserva como precio vivo de entrada para evaluar flips concretos. Así, BUFF no se convierte en objetivo de predicción ni en dependencia masiva de entrenamiento.
