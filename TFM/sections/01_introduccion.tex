...
La memoria sigue una progresión desde el marco conceptual y el caso de estudio hasta la formalización, la construcción de datos, la implementación y la evaluación. A continuación, se detalla el contenido de cada capítulo:

\begin{itemize}
  \item \textbf{Capítulo 1:} introduce el contexto del proyecto, la motivación, el problema abordado, los objetivos y la estructura de la memoria.
  ...
  \item \textbf{Capítulo 3:} contextualiza el caso de estudio: los artículos de \textit{Counter-Strike 2}, sus atributos, los mercados secundarios y las condiciones de intercambio.
  ...
  \item \textbf{Capítulo 5:} describe las fuentes de datos, su normalización y trazabilidad, las variables temporales y la validación de calidad del conjunto experimental antes del entrenamiento.
  \item \textbf{Capítulo 6:} describe la implementación y operación del sistema: sus componentes, la adquisición y persistencia de datos, el entrenamiento y ejecución de modelos y la consola local de consulta.
  \item \textbf{Capítulo 7:} presenta el diseño experimental y las verificaciones previas de la implementación. Después separa los resultados de aprendizaje --señal supervisada y MARL-- de los resultados económicos de la cartera, y finaliza con su discusión y limitaciones.
  \item \textbf{Capítulo 8:} sintetiza las conclusiones, revisa el cumplimiento de objetivos, delimita las limitaciones y propone líneas de trabajo futuro.
