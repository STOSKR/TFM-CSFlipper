...
\section{Formulación de la decisión simulada}

A partir del planteamiento descrito en el Capítulo 1, la propuesta representa el caso de uso como una tarea de decisión secuencial sobre una cartera simulada, siguiendo la formulación general del aprendizaje por refuerzo \cite{sutton2018reinforcement}. En cada instante, el sistema recibe datos de los mercados secundarios, el estado de la cartera y una estimación supervisada calculada a partir de datos históricos. Los datos de mercado describen el artículo y las publicaciones disponibles, mientras que el estado de cartera recoge, entre otros elementos, el saldo disponible, las posiciones abiertas y el capital bloqueado.

Con esta información, los agentes coordinan una propuesta de compra, venta o mantenimiento y comprueban si puede realizarse dentro del simulador. La compra requiere que el artículo, el precio de compra y el precio de venta previsto puedan compararse. La venta requiere que exista una posición del mismo artículo que no esté bloqueada y pueda venderse. Las restricciones de cartera pueden impedir que una propuesta se ejecute aunque la diferencia de precios parezca favorable.
...
La arquitectura organiza esta tarea en cinco capas: adquisición, persistencia, predicción, decisión multiagente y simulación. Las tres primeras obtienen, normalizan, conservan y transforman los datos en estimaciones a partir del histórico disponible. Las dos últimas utilizan esa información para coordinar decisiones y calcular sus consecuencias dentro del simulador. Esta separación evita confundir una estimación de mercado con una decisión de compraventa.
...
\subsection{Clasificación de oportunidades}
...
\begin{description}
    ...
    \item[\emph{Bloquear}] Los costes, el riesgo o las restricciones de cartera impiden continuar con la posible operación.
\end{description}
