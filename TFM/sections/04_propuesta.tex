...
Una vez definido el problema MARL, la arquitectura describe cómo se organizan los componentes necesarios para construir los estados, ejecutar las acciones y registrar sus consecuencias. La arquitectura se organiza en cinco capas: adquisición, persistencia, predicción, decisión multiagente y simulación. Cada capa recibe una salida definida de la anterior y entrega una entrada definida a la siguiente. Esta separación reduce el acoplamiento y permite comprobar cada parte por separado, una práctica habitual en entornos de evaluación reproducible \cite{liu2021finrl,pineau2021reproducibility}.

\textcolor{red}{Realmente la figura es una arquitectura MARL. Según lo que has dicho en la sección anterior, el estado sería los datos de mercado, la probabilidad del candidato y el estado de la cartera, no??? Podrías remarcar lo que es el estado en la figura}
