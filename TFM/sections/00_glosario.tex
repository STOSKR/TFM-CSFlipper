...
\begin{description}
  ...
  \item[Cartera] Conjunto formado por el saldo disponible y las posiciones abiertas. El saldo disponible puede utilizarse para nuevas operaciones, mientras que el capital asociado a una posición abierta permanece comprometido hasta su venta.
  ...
  \item[Oferta] Anuncio mediante el cual una persona pone a la venta un activo virtual identificado por sus características relevantes e indica su precio.
  \item[Operación] Secuencia formada por la compra de un activo y su posible venta posterior.
  \item[Orden de compra] Publicación que indica el precio máximo que una persona está dispuesta a pagar por un activo virtual concreto.
  ...
  \item[Posición abierta] Activo virtual ya adquirido que permanece en la cartera hasta su venta. Mientras la posición está abierta, el importe empleado en la compra no puede destinarse a otra operación.
  ...
  \item[Trade hold] Bloqueo temporal que impide vender o transferir un activo virtual recién adquirido.
\end{description}
\indicebottomrule
