...
\label{sec:estado-arte-supervisado}
...
\begin{figure}[H]
  ...
  \end{tikzpicture}
  \caption{Ciclo agente-entorno en aprendizaje por refuerzo.}
  \label{fig:ciclo-rl}
\end{figure}
...
\begin{figure}[H]
  ...
  \end{tikzpicture}
  \caption{MARL con entrenamiento centralizado y ejecución descentralizada.}
  \label{fig:marl-ctde}
\end{figure}
...
\label{sec:estado-arte-carteras-riesgo}
...
\label{sec:estado-arte-aplicaciones}
