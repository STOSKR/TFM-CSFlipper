...
\noindent Este capítulo sitúa el trabajo dentro de la literatura sobre economías virtuales, plataformas de intercambio y sistemas de decisión. Primero resume cómo se estudian los mercados de activos digitales en videojuegos. Después presenta las técnicas de aprendizaje y simulación que se emplean para analizar decisiones secuenciales. Los conceptos operativos y el caso de estudio se desarrollan en el Capítulo 3.

\section{Mercados y plataformas de activos digitales}

Los bienes virtuales pueden tener utilidad dentro de un videojuego y, cuando las reglas lo permiten, circular entre personas usuarias a través de mecanismos de intercambio. La investigación sobre consumo virtual muestra que la demanda no depende solo de una función dentro del juego. También intervienen la apariencia, la rareza, la identidad social y la percepción de valor del objeto \cite{lehdonvirta2009virtual,guo2009virtual}. Por ello, estos mercados comparten elementos con otros mercados de bienes diferenciados, como oferta, demanda, precios, costes de transacción y liquidez, aunque funcionan bajo reglas definidas por las plataformas y los desarrolladores.

Para este trabajo resulta útil distinguir tres configuraciones. Los mercados cerrados limitan la circulación del objeto al propio videojuego. Los mercados internos permiten intercambios entre usuarios con reglas y moneda controladas por la plataforma. Los mercados conectados a plataformas externas permiten comparar precios o intercambiar activos en más de un entorno. Esta clasificación no pretende abarcar todas las economías virtuales, sino identificar cuándo aparecen problemas de normalización, comisiones, liquidez y restricciones temporales.

Una plataforma de intercambio cumple varias funciones: muestra el catálogo disponible, registra ofertas de venta y órdenes de compra, aplica reglas de transacción y mantiene información sobre precios o actividad. El mercado puede estar gestionado por una empresa, mediante contratos distribuidos o por una solución híbrida. En todos los casos, la plataforma determina qué datos pueden observarse, qué operaciones están permitidas y qué costes se aplican. Estas decisiones condicionan la calidad de los datos disponibles para cualquier sistema de análisis.
