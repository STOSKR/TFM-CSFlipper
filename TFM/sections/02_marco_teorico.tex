...
En este \acroref{TFM}{TFM}, la rentabilidad se mide mediante beneficio neto, retorno porcentual, saldo final y evolución del valor de cartera. El riesgo se observa mediante \textit{drawdown} o caída máxima, capital bloqueado, exposición por activo o plataforma y operaciones rechazadas por restricciones. Estas métricas son más informativas que una simple precisión de predicción, porque conectan el modelo con el resultado económico simulado.

\Needspace{10\baselineskip}
El \textit{drawdown} mide cuánto ha caído el valor de la cartera desde su máximo anterior. Si $V_t$ es el valor de la cartera en el instante $t$ y $M_t=\max_{\tau\leq t}V_\tau$ es el mayor valor alcanzado hasta ese momento, se calcula como:

\[
DD_t = \frac{M_t - V_t}{M_t}.
\]

Por ejemplo, si una cartera alcanza 1.000 EUR y después baja a 900 EUR, su \textit{drawdown} es del 10\%. A diferencia de una pérdida de una operación aislada, esta medida refleja el retroceso acumulado de toda la cartera. Un valor cercano a cero indica que la cartera permanece próxima a su máximo reciente.
