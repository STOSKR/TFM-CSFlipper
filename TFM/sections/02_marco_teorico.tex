...
\noindent Este capítulo reúne los conceptos necesarios para interpretar la propuesta: cómo funcionan los mercados de activos digitales, qué costes y restricciones afectan a una operación y cómo se emplean el aprendizaje por refuerzo y los agentes cooperativos en problemas de decisión. El caso de \textit{Counter-Strike 2} se introduce como aplicación concreta del marco general.
