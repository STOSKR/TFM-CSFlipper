...
\begin{description}
  ...
  \item[\glostarget{mercado-integrado}{Mercado integrado}] Mercado administrado por el propio ecosistema del videojuego o de distribución, que controla el inventario y las reglas de intercambio.
  ...
  \item[\glostarget{plataforma-externa}{Plataforma externa}] Plataforma distinta del ecosistema que administra el inventario original y que publica ofertas o facilita operaciones sobre activos transferibles.
