...
\begin{description}
  ...
  \item[\glostarget{brier-score}{Brier score}] Métrica que evalúa el error de una probabilidad estimada comparándola con el resultado observado.
  \item[\glostarget{calibracion-probabilidades}{Calibración de probabilidades}] Comprobación de si las probabilidades producidas por un modelo coinciden con la frecuencia real observada.
  ...
  \item[\glostarget{checkpoint}{Checkpoint}] Modelo guardado durante o después de un entrenamiento para poder evaluarlo, reutilizarlo o continuar el proceso más adelante.
  ...
  \item[\glostarget{drawdown}{Drawdown}] Mayor caída del valor de una cartera respecto a un máximo anterior durante un periodo de evaluación.
  ...
  \item[\glostarget{exhaustividad}{Exhaustividad}] Métrica de clasificación, también llamada \emph{recall}, que mide qué proporción de los casos positivos reales detecta un modelo.
  ...
  \item[\glostarget{observabilidad-parcial}{Observabilidad parcial}] Situación en la que un agente no recibe el estado completo del entorno, sino una observación limitada de la información disponible.
  ...
  \item[\glostarget{proceso-decision-markov-parcialmente-observable}{Proceso de decisión de Markov parcialmente observable}] Modelo de decisión secuencial en el que el entorno mantiene un estado, pero el agente solo recibe observaciones parciales de ese estado.
  ...
  \item[\glostarget{retorno-inversion}{Retorno sobre la inversión}] Relación entre el beneficio neto de una operación y el importe invertido para realizarla. Permite comparar operaciones de distinto tamaño.
  \item[\glostarget{rendimiento-tecnico}{Rendimiento técnico}] Medida del coste práctico de ejecutar un sistema, como tiempo de proceso, volumen de datos tratado o recursos utilizados.
