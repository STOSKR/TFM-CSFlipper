...
\section{Mercado digital y plataformas}

Un \emph{mercado digital} es el entorno donde se publican, consultan y aceptan intercambios de activos. Una \emph{plataforma de distribución digital} ofrece además acceso al juego, a la cuenta y, en algunos casos, al inventario de la persona usuaria. No todas las plataformas cumplen el mismo papel. Algunas gestionan el inventario y el intercambio oficial, mientras otras muestran precios, facilitan la comparación o permiten publicar ofertas con reglas propias.
...
\section{Precio, liquidez y fricciones}
...
Steam aporta inventario, anuncios, órdenes de compra e histórico cuando está disponible. \acroref{BUFF}{BUFF} se utiliza como fuente externa de comparación de precios y profundidad de mercado. SteamDT sirve para localizar artículos que conviene analizar con más detalle. Ninguna de estas fuentes se toma como verdad única. El sistema conserva su origen, fecha, moneda y calidad para que una comparación posterior pueda reconstruirse y revisarse.
