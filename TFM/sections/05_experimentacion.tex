...
\bottomrule
\end{tabularx}
\caption{Corte reciente de BUFF a Steam.}
...
\bottomrule
\end{tabularx}
\caption{Pruebas automatizadas ejecutadas.}
...
\midrule
Fixture de texto & Dos líneas se convierten en observaciones Steam y BUFF con precio y volumen normalizados. & No representa una captura de interfaz. \\
Umbral de confianza & Una extracción con confianza 0,2 se rechaza al exigir 0,5. & No estima falsos positivos ni falsos negativos. \\
Recorrido de imagen & La prueba inyectada verifica carga, preprocesado y resultado con confianza 0,91. & La confianza procede de un runner controlado. \\
\bottomrule
\end{tabularx}
\caption{Evidencia funcional del pipeline OCR.}
