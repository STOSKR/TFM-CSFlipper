...
\bottomrule
\end{tabularx}
\caption{Resultados del corte temporal de marzo.}
...
\caption{Comparación de modelos y ablación temporal en marzo. Un Brier menor indica mejor calibración.}
\label{fig:modelos-marzo}
\end{figure}

El mejor resultado del corte es la regresión logística sin características históricas. Su ROC-AUC alcanza 0,760 y su Brier es 0,072. Por tanto, en este periodo concreto los retardos y medias móviles no aportan una mejora medible. Random forest se acerca con ROC-AUC de 0,742. El resultado no permite concluir que las características temporales sean inútiles en cualquier periodo, pero sí descarta asumir su beneficio sin contrastarlo.
