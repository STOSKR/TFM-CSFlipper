...
Con la base de datos conectada se repitió la construcción del dataset el 11 de agosto de 2026. Se empleó la ventana desde diciembre de 2025, un horizonte de ocho días, una purga de ocho días y una prueba acotada a julio de 2026. La comprobación usa las dos direcciones de intercambio disponibles y conserva los mismos 19 artículos. El resultado no habilita otro entrenamiento. Sirve para comprobar si la nueva captura ha aportado variedad suficiente de etiquetas.

\begin{table}[htbp]
\centering
\begin{tabularx}{\textwidth}{>{\raggedright\arraybackslash}X r r r >{\raggedright\arraybackslash}X}
\toprule
Ruta & Entrenamiento & Validación & Prueba & Lectura \\
\midrule
BUFF $\rightarrow$ Steam & 551 / 95,6\% + & 76 / 100\% + & 84 / 98,8\% + & Predominan los márgenes positivos. \\
Steam $\rightarrow$ BUFF & 551 / 0\% + & 76 / 0\% + & 84 / 0\% + & Predominan los márgenes negativos. \\
\bottomrule
\end{tabularx}
\caption{Distribución del corte reciente.}
\label{tab:corte-reciente}
\end{table}

El contraste es deliberadamente incómodo, pero es importante. En ambas rutas falta una clase en validación y prueba, por lo que ROC-AUC, calibración y una comparación de políticas no son interpretables. Entrenar con esta muestra produciría una clasificación trivial y no aportaría evidencia sobre el sistema. La prioridad experimental pasa a ser mantener capturas recurrentes de más artículos, incluir oportunidades descartadas y conservar decisiones cerradas para que la recompensa MARL pueda distinguir compras acertadas, compras fallidas y decisiones de espera.
