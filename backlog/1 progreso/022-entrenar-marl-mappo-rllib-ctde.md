...
- Lo implementado ahora es PPO multiagente con recompensa compartida. Ejecuta entrenamiento
  y checkpoint, pero no debe venderse como MAPPO CTDE completo hasta implementar el critico
  centralizado.
